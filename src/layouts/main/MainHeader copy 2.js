...
function Header(props) {
  ...
  const handlePopoverOpen = (event,page) => {
      ...
      <AppBar component="nav" sx={{backgroundColor:"transparent", boxShadow:"none", position: "absolute"}} >
        <Toolbar >
          ...
          <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
            {/* <Button key={1}
              onMouseEnter={(event) => handlePopoverOpen(event,'destination')}
              onMouseLeave={handlePopoverClose}
            >
              <Link style={styles.textColor} to="/destination">DESTINATIONS</Link>
            </Button>
            <Button key={2}
              onMouseEnter={(event) => handlePopoverOpen(event,'activities')}
              onMouseLeave={handlePopoverClose}
            >
            ...
            <Button key={8} sx={{ color: '#fff',fontSize:'50px'}}
            ...
            <Popover
              ...
              disableRestoreFocus
            >
              <Typography sx={{ p: 1 }}>I use Popover. 11111</Typography>
            </Popover>
            {/* <Button key={1}>
              <Link style={styles.textColor} to="/destination">DESTINATIONS</Link>
            </Button>

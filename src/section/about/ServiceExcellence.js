...
const ServiceExcellence = () => {
  ...
  return (
    <>
      <Box sx={{ flexGrow: 1 }} className='serviceExcellence relative' pt='0'>
            ...
            <Grid item xs={12} className="aboutSlider">
              <OwlCarousel className='owl-theme' {...ServiceExcellence}>
                <div class='item'>
                  ...
                  >
                    <img src={`${process.env.REACT_APP_URL}images/service-excellence/1.jpg`} alt="" />
                  </Paper>
                </div>
                <div class='item'>
                  <Paper component="a" href="/" className="popularToursSlider"
                  ...
                  >
                    <img src={`${process.env.REACT_APP_URL}images/service-excellence/2.jpg`} alt="" />
                  </Paper>
                </div>
                <div class='item'>
                  <Paper component="a" href="/" className="popularToursSlider"
                  ...
                  >
                    <img src={`${process.env.REACT_APP_URL}images/service-excellence/3.jpg`} alt="" />
                  </Paper>
                </div>
                <div class='item'>
                  <Paper component="a" href="/" className="popularToursSlider"
                  ...
                  >
                    <img src={`${process.env.REACT_APP_URL}images/service-excellence/4.jpg`} alt="" />
                  </Paper>
                </div>
                <div class='item'>
                  <Paper component="a" href="/" className="popularToursSlider"
                  ...
                  >
                    <img src={`${process.env.REACT_APP_URL}images/service-excellence/5.jpg`} alt="" />
                  </Paper>
                </div>
                <div class='item'>
                  <Paper component="a" href="/" className="popularToursSlider"

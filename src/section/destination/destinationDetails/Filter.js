...
const Filter = (props) => {
  ...
  useEffect(()=>{
    if (props) {
      setFilterData([{ index: Math.random(), country: [props.destinationDetails.id], activity: [], difficulty: [], region: [], price: '', duration: '', sortByName: '', sortByValue: '', review: '' }]);
      setTourData([]);
      setTotalPage('');
      setPage('');
      handleFilterAPI();
                ...
                <Grid container direction="row" spacing={2} padding={0}>
                  ...
                  {/* <Grid item xs={12} md={4} sm={6} lg={4}>
                    <Paper sx={{ boxShadow: "none", backgroundColor: 'transparent' }} className="popularToursSlider">
                      <div className="ptsWrapTop relative">
                        ...
                        <span className='newSpan bgGreen'>New</span>
                        <div className='dolerPp'>
                          <h6>From <span>$1,258</span></h6>
                          <h5>US $1,258<sup>pp</sup></h5>
                        </div>
                      </div>
                      <div className='ptsWrap'>
                        ...
                        <div className='ptsInner'>
                          ...
                          <Box mt={1}>
                            <List component={Stack} direction="row" className='dudiAct'>
                              <ListItem disablePadding sx={{ pr: '0' }}>
                                <span><img src="../images/icon/duration.svg" alt="" /></span> Duration
                              </ListItem>
                              <ListItem disablePadding>
                                <span><img src="../images/icon/difficulty.svg" alt="" /></span> Dificulty
                              </ListItem>
                              <ListItem disablePadding>
                                <span><img src="../images/icon/activity.svg" alt="" /></span>Activity
                              </ListItem>
                            </List>
                          </Box>
                          <Box>
                            <List component={Stack} direction="row">
                              ...
                              <ListItem disablePadding>
                                <span>5.0 </span>of <strong>47 Reviews</strong>
                              </ListItem>
                            </List>
                          </Box>
                        </div>
                  ...
                  <Grid item xs={12} md={4} sm={6} lg={4}>
                    <Paper sx={{ boxShadow: "none", backgroundColor: 'transparent' }} className="popularToursSlider">
                      <div className="ptsWrapTop relative">
                        <img src="../images/package/2.jpg" alt="" />
                        <span className='newSpan bgParple'>New</span>
                        <div className='dolerPp'>
                          <h6>From <span>$1,258</span></h6>
                          <h5>US $1,258<sup>pp</sup></h5>
                        </div>
